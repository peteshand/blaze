...
{
	import imag.masdar.core.view.starling.display.base.AlignmentSprite;
	 ...
	 * @author Pete Shand
	 */
	public class BaseStarlingObject extends AlignmentSprite 
	{
		...
		public function BaseStarlingObject() 
		{
			super();
			assets = core.assets;
			config = core.config;
