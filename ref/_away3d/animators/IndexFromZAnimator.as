package imag.masdar.core.view.away3d.animators
{
	 ...
	 */
	public class IndexFromZAnimator extends AnimatorBase implements IAnimator
	{
		private var _indexFromZAnimationSet:IndexFromZAnimationSet;
		 ...
		 *
		 * @param indexFromZAnimationSet The animation data set containing the vertex animations used by the animator.
		 */
		public function IndexFromZAnimator(indexFromZAnimationSet:IndexFromZAnimationSet)
		{
			super(indexFromZAnimationSet);
			
			_indexFromZAnimationSet = indexFromZAnimationSet;
			_numPoses = indexFromZAnimationSet.numPoses;
			_blendMode = indexFromZAnimationSet.blendMode;
		}
		...
		{
			return new IndexFromZAnimator(_indexFromZAnimationSet);
		}
