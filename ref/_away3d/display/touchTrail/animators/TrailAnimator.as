package imag.masdar.core.view.away3d.display.touchTrail.animators
{
	 ...
	 */
	public class TrailAnimator extends AnimatorBase implements IAnimator
	{
		private var _trailAnimationSet:TrailAnimationSet;
		 ...
		 *
		 * @param trailAnimationSet1 The animation data set containing the vertex animations used by the animator.
		 */
		public function TrailAnimator(trailAnimationSet:TrailAnimationSet)
		{
			super(trailAnimationSet);
			
			_trailAnimationSet = trailAnimationSet;
			_numPoses = trailAnimationSet.numPoses;
			_blendMode = trailAnimationSet.blendMode;
		}
		...
		{
			return new TrailAnimator(_trailAnimationSet);
		}
