package imag.masdar.core.view.away3d.display.shell.dotScrollbr.animators
{
	 ...
	 */
	public class LinearLineBatchAnimator extends AnimatorBase implements IAnimator
	{
		private var _linearLineBatchAnimationSet:LinearLineBatchAnimationSet;
		 ...
		 *
		 * @param linearLineBatchAnimationSet The animation data set containing the vertex animations used by the animator.
		 */
		public function LinearLineBatchAnimator(linearLineBatchAnimationSet:LinearLineBatchAnimationSet)
		{
			super(linearLineBatchAnimationSet);
			
			_linearLineBatchAnimationSet = linearLineBatchAnimationSet;
			_numPoses = linearLineBatchAnimationSet.numPoses;
			_blendMode = linearLineBatchAnimationSet.blendMode;
		}
		...
		{
			return new LinearLineBatchAnimator(_linearLineBatchAnimationSet);
		}
